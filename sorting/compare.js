...
var testo = "Two of the most common operations performed on data stored in a computer are sorting and searching. This has been true since the beginning of the computer industry, so this means that sorting and searching are two of the most studied operations in computer science. Many of the data structures discussed in this book are designed primarily to make sorting and/or searching the data stored in the data structure easier and more efficient."
var parole = testo.split(" ");
var numElements = parole.length;
var nums = new CArray(numElements, parole);
// nums.setData();
...
// inserendo l'istruzione: console.log(nums.toString()) è possibile controllare il risultato del sort. Funziona.